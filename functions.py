...
def updateFolder(cameraip,frame, cropPic, transformed_image, final_image):
	...
	for file in list_Files:
		if file.split(".")[0:4] == imgtest.split(".")[0:4]:
			locFile = r'C:/Users/kzhu/Desktop/imageView/static'
	...
	for file in list_Files:
		if file.split(".")[0:5] == imgCrop.split(".")[0:5]:
			locPath = r"C:/Users/kzhu/Desktop/imageView/static" 
	...
	cv2.imwrite(r'C:/Users/kzhu/Desktop/imageView/static/{}'.format(imgtest),frame)
	cv2.imwrite(r'C:/Users/kzhu/Desktop/imageView/static/{}'.format(imgCrop),cropPic)
	cv2.imwrite(r'C:/Users/kzhu/Desktop/imageView/static/{}'.format(imgTransform),transformed_image)
	cv2.imwrite(r'C:/Users/kzhu/Desktop/imageView/static/{}'.format(imgFinal),final_image)
